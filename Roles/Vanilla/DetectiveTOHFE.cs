...
internal class DetectiveTOHFE : RoleBase
{
    //===========================SETUP================================\\
    public override CustomRoles Role => CustomRoles.DetectiveTOHFE;
    ...
    {
        Options.SetupRoleOptions(Id, TabGroup.CrewmateRoles, CustomRoles.DetectiveTOHFE);
        DetectiveSuspectLimit = IntegerOptionItem.Create(Id + 2, GeneralOption.DetectiveBase_DetectiveSuspectLimit, new(2, 4, 1), 2, TabGroup.CrewmateRoles, false)
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.DetectiveTOHFE])
