...
internal class Forensic : RoleBase
{
   ...
   private static OptionItem ForensicCanknowKiller;
   ...
   public override void SetupCustomOption()
   {
       ...
       ForensicCanknowKiller = BooleanOptionItem.Create(7902, "ForensicCanknowKiller", true, TabGroup.CrewmateRoles, false)
   ...
   public override void OnReportDeadBody(PlayerControl player, NetworkedPlayerInfo deadBody)
   {
       ...
       if (player != null && player.Is(CustomRoles.Forensic) && player.PlayerId != deadBody.PlayerId)
       {
           ...
           msg.Append(string.Format(GetString("ForensicNoticeVictim"), deadBody.PlayerName, RoleDeadBodyInfo));
           ...
           if (ForensicCanknowKiller.GetBool())
           {
               ...
               if (realKiller == null
                   ...
                   msg.Append($"；\n{GetString("ForensicNoticeKillerNotFound")}");
               ...
               else
               {
                   ...
                   msg.Append($"；\n{string.Format(GetString("ForensicNoticeKiller"), RoleKillerInfo)}");
               }
           }
           Notify = msg.ToString();
       }
   ...
   public override void OnMeetingHudStart(PlayerControl pc)
   {
       ...
       AddMsg(Notify, pc.PlayerId, Utils.ColorString(Utils.GetRoleColor(CustomRoles.Forensic), GetString("ForensicNoticeTitle")));
   }
