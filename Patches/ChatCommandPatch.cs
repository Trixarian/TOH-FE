...
#else
    private static readonly string modLogFiles = Path.Combine(UnityEngine.Application.persistentDataPath, "TOHFE-DATA", "ModLogs.txt");
    private static readonly string modTagsFiles = Path.Combine(UnityEngine.Application.persistentDataPath, "TOHFE-DATA", "MOD_TAGS");
    private static readonly string sponsorTagsFiles = Path.Combine(UnityEngine.Application.persistentDataPath, "TOHFE-DATA", "SPONSOR_TAGS");
    private static readonly string vipTagsFiles = Path.Combine(UnityEngine.Application.persistentDataPath, "TOHFE-DATA", "VIP_TAGS");
#endif
