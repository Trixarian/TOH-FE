...
public static class Translator
{
    ...
    public static void LoadLangs()
    {
        try
        {
            // Get the directory containing the JSON files (e.g., TOHFE.Resources.Lang)
            string jsonDirectory = "TOHFE.Resources.Lang";
    ...
    //{
    //    var assembly = System.Reflection.Assembly.GetExecutingAssembly();
    //    var stream = assembly.GetManifestResourceStream("TOHFE.Resources.String.csv");
